git clone https://github.com/rodriguezst/linux.git --branch $1 --depth 1 linux
cd linux
make -j$(nproc) ARCH=arm64 CROSS_COMPILE=aarch64-linux-gnu- xiaomi_nabu_defconfig
make -j$(nproc) ARCH=arm64 CROSS_COMPILE=aarch64-linux-gnu-
_kernel_version="$(make kernelrelease -s)"
mkdir ../linux-xiaomi-nabu/boot
cp arch/arm64/boot/Image.gz ../linux-xiaomi-nabu/boot/vmlinuz-$_kernel_version
cp arch/arm64/boot/dts/qcom/sm8150-xiaomi-nabu-maverick.dtb ../linux-xiaomi-nabu/boot/dtb-$_kernel_version
